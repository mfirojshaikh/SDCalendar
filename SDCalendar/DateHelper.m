...
#pragma mark - GetIndexes

-(NSInteger)firstWeekdayOfMonthIndex:(NSDate*)date
{
    NSDate *firstWeekDay=[self firstWeekDayOfWeek:date];
    NSDateComponents *componentsCurrentDate = [self.calendar components:NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay|NSCalendarUnitWeekday|NSCalendarUnitWeekOfMonth fromDate:firstWeekDay];
    return componentsCurrentDate.day;
}
...
-(NSInteger)lastDayIntegerOfMonth:(NSDate *)date
{
    ...
    NSDate *lastDate=[self.calendar dateFromComponents:componentsNewDate];
    NSDateComponents *componants=[self.calendar components:NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay|NSCalendarUnitWeekday|NSCalendarUnitWeekOfMonth fromDate:lastDate];
    return componants.day;
}
